...
public class CircleProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        progressTextSize = array.getDimensionPixelSize(R.styleable.CircleProgressView_progressTextSize, progressTextSize);
        ...
        progressRadius = array.getDimension(R.styleable.CircleProgressView_progressRadius, progressRadius);
