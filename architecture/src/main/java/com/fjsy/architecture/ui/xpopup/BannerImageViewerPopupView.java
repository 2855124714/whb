...
public class BannerImageViewerPopupView extends BasePopupView implements OnDragChangeListener, View.OnClickListener {
    ...
    public BannerImageViewerPopupView(@NonNull Context context) {
        super(context);
...
//                srcViewUpdateListener.onSrcViewUpdate(BannerImageViewerPopupView.this, i);
            }
        }
    };
...
//        snapshotView.setImageDrawable(srcView.getDrawable());
    ...
    public void doShowAnimation() {
        if (srcView == null) {
            ...
            BannerImageViewerPopupView.super.doAfterShow();
            return;
        }
    ...
    public BannerImageViewerPopupView setImageUrls(List<String> urls) {
        this.urls = urls;
        return this;
    }

    public BannerImageViewerPopupView setSrcViewUpdateListener(OnSrcViewUpdateListener srcViewUpdateListener) {
        this.srcViewUpdateListener = srcViewUpdateListener;
        return this;
    }

    public BannerImageViewerPopupView setXPopupImageLoader(XPopupImageLoader imageLoader) {
     ...
     * @return
     */
    public BannerImageViewerPopupView isShowPlaceholder(boolean isShow) {
     ...
     * @return
     */
    public BannerImageViewerPopupView isShowIndicator(boolean isShow) {
     ...
     * @return
     */
    public BannerImageViewerPopupView isShowSaveButton(boolean isShowSaveBtn) {
        this.isShowSaveBtn = isShowSaveBtn;
        return this;
    }

    public BannerImageViewerPopupView isInfinite(boolean isInfinite) {
        this.isInfinite = isInfinite;
        return this;
    }

    public BannerImageViewerPopupView setPlaceholderColor(int color) {
        this.placeholderColor = color;
        return this;
    }

    public BannerImageViewerPopupView setPlaceholderRadius(int radius) {
        this.placeholderRadius = radius;
        return this;
    }

    public BannerImageViewerPopupView setPlaceholderStrokeColor(int strokeColor) {
     ...
     * @return
     */
    public BannerImageViewerPopupView setSingleSrcView(ImageView srcView, String url) {
        if (this.urls == null) {
            urls = new ArrayList<>();
        }
        urls.clear();
    ...
    public BannerImageViewerPopupView setSrcView(ImageView srcView, int position) {
