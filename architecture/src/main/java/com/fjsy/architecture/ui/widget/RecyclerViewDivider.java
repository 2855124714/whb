...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    RecyclerViewDivider() {
        dividerDrawable = new ColorDrawable(Color.parseColor("#F0F0F0"));
    }
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent, int lineWidth, int lineHeight) {
        ...
        int adapterCount = 0;// 总个数
        if (parent.getAdapter() != null)
            adapterCount = parent.getAdapter().getItemCount();
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, int lineWidth, int lineHeight) {
        ...
        RecyclerView.LayoutManager layoutManager = parent.getLayoutManager();
        if (layoutManager instanceof StaggeredGridLayoutManager &&
                ((StaggeredGridLayoutManager) layoutManager).getOrientation() == StaggeredGridLayoutManager.VERTICAL)
            // 绘制双线
            isDrawDoubleLine = true;
        canvas.save();
        if (parent.getClipToPadding()) {
    ...
    public static class Builder {
        ...
        Builder() {
            recyclerViewDivider = new RecyclerViewDivider();
        }
        ...
        public Builder width(int lineWidth) {
            recyclerViewDivider.setLineWidth(lineWidth);
            return this;
        }
        ...
        public Builder height(int lineHeight) {
            recyclerViewDivider.setLineHeight(lineHeight);
            return this;
        }
        ...
        public Builder widthAndHeight(int lineSize) {
            recyclerViewDivider.setLineWidth(lineSize);
            recyclerViewDivider.setLineHeight(lineSize);
            return this;
        }
        ...
        public Builder color(int lineColor) {
            recyclerViewDivider.setLineColor(lineColor);
            return this;
        }
        ...
        public Builder drawable(Drawable dividerDrawable) {
            recyclerViewDivider.setDividerDrawable(dividerDrawable);
            return this;
        }
        ...
        public Builder headerCount(int headerCount) {
            recyclerViewDivider.setHeaderCount(headerCount);
            return this;
        }
        ...
        public Builder footerCount(int footerCount) {
            recyclerViewDivider.setFooterCount(footerCount);
            return this;
        }
