...
import com.fjsy.architecture.global.data.bean.DownModel;
...
//        downModel.save();
    ...
    public void downLoadFile(final DownModel downModel) {
        ...
        retrofit.create(GlobalBaseService.class)
                ...
                .map(new Function<ResponseBody, File>() {
                    ...
                    public File apply(ResponseBody responseBody) throws Exception {
                        if (downModel.getDownSize() > 0) {
                            //断点下载
                            return DownloadFileUtils.saveFile(responseBody.byteStream(), downModel.getDownSize(), downModel.getDestDir(), downModel.getName());
                        }
                        return DownloadFileUtils.saveFile(responseBody.byteStream(), downModel.getDestDir(), downModel.getName());
                    }
                })
